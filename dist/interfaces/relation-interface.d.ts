...
export interface GenerateBelongsToManyInterface extends GenerateBelongsToInterface {
    pivotCollection: string;
}
export interface HasManyThroughInterface extends BelongsToInterface {
    throughCollection: string;
}
export interface GenerateHasManyThroughInterface extends GenerateBelongsToInterface {
    throughCollection: string;
}
